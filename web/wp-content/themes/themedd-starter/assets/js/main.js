!function(a) {
    ...
    a('a[href$=".jpg"], a[href$=".jpeg"], a[href$=".gif"], a[href$=".png"]').each(function() {
        var b = a(this), c = b.find("img");
        (c.is('[class*="wp-image"]') || c.is('[class*="attachment"]')) && b.attr("data-modal-image", "true");
    });
}(jQuery), function(a) {
    a("[data-modal-content]").magnificPopup({
        type: "inline",
        midClick: !0
    }), a("[data-modal-image]").magnificPopup({
        type: "image"
    });
